...
awk -F, '/hilton|hilton/ && $16 != -1 && $16 != 0 {country=tolower($7); hilton_cleanliness[country]+=$16; hilton_count[country]+=1}
         /holiday_inn/ && $16 != -1 && $16 != 0 {country=tolower($7); holiday_inn_cleanliness[country]+=$16; holiday_inn_count[country]+=1}
