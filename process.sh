...
awk -F, '/hilton|hilton/ && $11 != -1 {split($1, a, "_"); country=tolower(a[1]); hilton_cleanliness[country]+=$11; hilton_count[country]+=1}
         /holiday_inn/ && $11 != -1 {split($1, a, "_"); country=tolower(a[1]); holiday_inn_cleanliness[country]+=$11; holiday_inn_count[country]+=1}
